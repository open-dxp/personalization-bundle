...
The following core concepts are the essential parts of OpenDxps personalization engine.  
...
OpenDxp Documents provide the possibility to create varying content variants for each defined target group. Once a target 
...
When delivering content to the visitor, the best matching variant is picked by OpenDxp. *Best matching* is in this case 
