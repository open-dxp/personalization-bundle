...
OpenDxp provides two ways for profiling visitors based on their behavior. 


### Associate Target Groups directly with OpenDxp Documents

It is possible to associate OpenDxp documents directly with target groups. This can be configured in `Settings` tab of 
