...
OpenDxp provides two ways to deliver personalized Content: 


### Delivering Personalized Content with Documents

When a document is delivered to the visitor, the best matching variant is picked by OpenDxp based on following rule:    
...
In addition to OpenDxp document delivery, global targeting rules provide two actions with further possibilities to 
...
for a certain request, which target groups are assigned and what data is collected, OpenDxp injects several information 
