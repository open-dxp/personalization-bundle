...
As the OpenDxp behavioral targeting engine is very powerful and flexible, there are multiple ways to archive a result 
...
For a live demo with a predefined rule set see our [Demo](https://demo.opendxp.io). 
