 ...
 * ACTION TYPES
 */
opendxp.registerNS("opendxp.bundle.personalization.settings.actions");
/**
 * @private
 */
opendxp.bundle.personalization.settings.actions = (function () {
    var actions = {
        redirect: Class.create(opendxp.bundle.personalization.settings.action.abstract, {
            getName: function () {
                return t("redirect");
            },
            ...
            getPanel: function (panel, data) {
                ...
                return new Ext.form.FormPanel({
                    ...
                    tbar: opendxp.bundle.personalization.settings.actions.getTopBar(this, id, panel),
                    items: [
                        {
                            xtype: "textfield",
                            width: 450,
        ...
        codesnippet: Class.create(opendxp.bundle.personalization.settings.action.abstract, {
            getName: function () {
        ...
        assign_target_group: Class.create(opendxp.bundle.personalization.settings.action.abstract, {
            getName: function () {
