 ...
 * CONDITION TYPES
 */
opendxp.registerNS("opendxp.bundle.personalization.settings.conditions");
/**
 * @private
 */
opendxp.bundle.personalization.settings.conditions = (function () {
    var conditions = {
        url: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
            ...
            getPanel: function (panel, data) {
                ...
                return new Ext.form.FormPanel({
                    ...
                    tbar: opendxp.bundle.personalization.settings.conditions.getTopBar(this, id, panel, data),
                    items: [{
                        xtype: "textfield",
        ...
        browser: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
                return t("browser");
            },
        ...
        country: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {

            isAvailable : function () {
                return opendxp.settings['maxmind_geoip_installed'];
            },
                ...
                return new Ext.form.FormPanel({
                    ...
                    items: [{
                        ...
                        store: new Ext.data.JsonStore({
                            ...
                            proxy: {
                                type: 'ajax',
                                url: Routing.generate('opendxp_admin_misc_countrylist'),
                                reader: {
                                    type: 'json',
                                    rootProperty: 'data'
                                }
        ...
        language: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
                return t("language");
            },
                ...
                return new Ext.form.FormPanel({
                    ...
                    items: [{
                        ...
                        store: new Ext.data.JsonStore({
                            ...
                            proxy: {
                                type: 'ajax',
                                url: Routing.generate('opendxp_admin_misc_languagelist'),
                                reader: {
                                    type: 'json',
                                    rootProperty: 'data'
                                }
        ...
        geopoint: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
                    ...
                    var handler = function () {
                        ...
                        var searchHandler = function() {
                            ...
                            opendxp.helpers.sendRequest(
                                "GET",
                                opendxp.bundle.personalization.settings.conditions.getSearchUrl(address),
                                function (response) {
        ...
        referringsite: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
        ...
        searchengine: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
        ...
        visitedpagebefore: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
            ...
            getPanel: function (panel, data) {
                ...
                var warningIconHtml = '<span style="display: inline-block; height: 16px; width: 16px" class="opendxp_icon_warning">&nbsp;</span> ';
                ...
                var items = [
                    ...
                    },
                    {
                        xtype: "displayfield",
                        hideLabel: true,
                        value: warningIconHtml + ' DEPRECATED! Will be removed in OpenDXP 2',
                ...
                if ('undefined' === typeof opendxp.settings.piwik || !opendxp.settings.piwik.configured || !opendxp.settings.piwik.report_token_configured) {
                    items.push({
                        xtype: "displayfield",
                        hideLabel: true,
        ...
        visitedpagesbefore: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
        ...
        timeonsite: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
        ...
        hardwareplatform: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
        ...
        operatingsystem: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
        ...
        target_group: Class.create(opendxp.bundle.personalization.settings.condition.abstract, {
            getName: function () {
