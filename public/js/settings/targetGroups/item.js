...
opendxp.registerNS("opendxp.bundle.personalization.settings.targetGroups.item");
/**
 * @private
 */
opendxp.bundle.personalization.settings.targetGroups.item = Class.create({
    ...
    getSettings: function () {
        this.settingsForm = new Ext.form.FormPanel({
            id: "opendxp_target_groups_panel_" + this.data.id,
    ...
    save: function () {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_bundle_personalization_targeting_targetgroupsave'),
            method: 'PUT',
            params: {
                id: this.data.id,
