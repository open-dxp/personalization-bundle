...
class OpenDxpPersonalizationExtension extends ConfigurableExtension
{
    ...
    {
        $container->setParameter('opendxp_personalization.targeting.enabled', $config['enabled']);
        $container->setParameter('opendxp_personalization.targeting.conditions', $config['conditions']);
        // @phpstan-ignore-next-line
        if (!$container->hasParameter('opendxp.geoip.db_file')) {
            $container->setParameter('opendxp.geoip.db_file', '');
        }
        ...
        $container->setParameter('opendxp_personalization.targeting.session.enabled', $config['session']['enabled'] ?? false);
